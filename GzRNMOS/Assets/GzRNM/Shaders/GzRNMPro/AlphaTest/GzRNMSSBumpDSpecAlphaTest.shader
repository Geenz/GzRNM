...
*/
Shader "GzRNMPro/SM2/Alpha Cutout/RNM SSBumped Direct Specular" {
	Properties {
		...
		_SpecMulti			("Specular Multiplier", Float) = 1
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf GzBlinnPhong vertex:vert nolightmap alphatest:_Cutoff
		#pragma glsl
		#pragma target 3.0
